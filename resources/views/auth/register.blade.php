            ...
            <form action="{{ route('register.save') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input name="name" type="text" id="name" placeholder="Enter your name"
                        class="w-full p-4 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none text-gray-800 @error('name') border-red-500 @enderror" />
                    @error('name')
                ...
                <div>
                    <label for="password_confirmation" class="block text-base font-medium text-gray-500">Confirm
                        Password</label>
                    <input name="password_confirmation" type="password" id="password_confirmation"
                        placeholder="Confirm your password"
                        class="w-full p-4 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none text-gray-800 @error('password_confirmation') border-red-500 @enderror" />
                ...
                <div class="flex justify-center">
                    <button type="submit"
                        class="w-full py-4 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-300">Register
                        Account</button>
                </div>
